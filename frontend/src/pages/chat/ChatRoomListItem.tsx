...
function ChatRoomListItem({
  ...
  return (
    ...
    >
        ...
        {isRenaming ? (
          ...
          <>
            ...
            <button
              ...
              className={`grid h-7 w-7 shrink-0 place-items-center rounded-full transition ${
                chatRoom.chat_is_pinned
                  ? 'text-violet-600 opacity-100 hover:bg-white'
                  : 'text-slate-400 opacity-0 hover:bg-white hover:text-violet-500 group-hover:opacity-100 group-focus-within:opacity-100'
              }`}
              aria-label={
                chatRoom.chat_is_pinned
                  ? '대화방 고정 해제'
            ...
            <button
              ...
              disabled={isBusy}
              className="grid h-7 w-7 shrink-0 place-items-center rounded-full text-slate-400 opacity-0 transition hover:bg-white hover:text-violet-500 group-hover:opacity-100 group-focus-within:opacity-100"
              aria-label="대화방 메뉴"
      ...
      {isMenuOpen && (
        <div className="mx-1 mt-1 grid grid-cols-1 gap-1 rounded-xl border border-violet-100 bg-white p-1.5 shadow-lg">
          <button
            type="button"
            onClick={startRenaming}
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs text-slate-600 hover:bg-violet-50 hover:text-violet-600"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs text-rose-500 hover:bg-rose-50"
          >
